...
CREATE TABLE TYPEU(
   CODETU NUMBER(6) PRIMARY KEY,
   NOMTU VARCHAR2(16)
);

CREATE TABLE GAMME(
   CODEG VARCHAR2(3) PRIMARY KEY,
   NOMG VARCHAR2(50)
);
